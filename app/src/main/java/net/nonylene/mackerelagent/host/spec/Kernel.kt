...
fun getKernelSpec(): KernelSpec {
    val osType = File("/proc/sys/kernel/ostype").readText()
    val osRelease = File("/proc/sys/kernel/osrelease").readText()
    val osVersion = File("/proc/sys/kernel/version").readText()
